...
public class RegistroSedes1 {
	...
	public String escribirRegistro(ArrayList<SedesDTO> apost) {
	...
	public ArrayList<SedesDTO> leerRegistro() {
        ObjectInputStream in;
        ArrayList<SedesDTO> datos = new ArrayList<>();
        f=new File(ruta);
		try {
			fis = new FileInputStream(f);
			dis = new DataInputStream(fis);
			in = new ObjectInputStream(new FileInputStream(ruta));
	        datos = (ArrayList<SedesDTO>)in.readObject();
	        in.close();
